...
import currentRestaurant from './reducers/currentRestaurant';
import currentZipcode from './reducers/currentZipcode';
...
const rootReducer = combineReducers({allRestaurants, currentRestaurant, currentZipcode});
